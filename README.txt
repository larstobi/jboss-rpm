...
2) unzip the zipfile to src main
...
4) build with 'mvn install'.
   The resulting RPM file is located at target/rpm/jboss-eap/RPMS/noarch/.


[1] http://anonsvn.jboss.org/repos/jbossas/tags/JBPAPP_5_0_0_GA/jbossas/
